...
import com.retrodevxp.pixeldungeon.items.quest.CorpseDust;
import com.retrodevxp.pixeldungeon.items.quest.PhantomFish;
...
import com.retrodevxp.pixeldungeon.items.wands.WandOfSlowness;
import com.retrodevxp.pixeldungeon.levels.Level;
import com.retrodevxp.pixeldungeon.levels.PrisonLevel;
import com.retrodevxp.pixeldungeon.levels.Room;
import com.retrodevxp.pixeldungeon.levels.Terrain;
import com.retrodevxp.pixeldungeon.plants.Rotberry;
import com.retrodevxp.pixeldungeon.scenes.GameScene;
import com.retrodevxp.pixeldungeon.sprites.WandmakerSprite;
import com.retrodevxp.pixeldungeon.utils.Utils;
import com.retrodevxp.pixeldungeon.windows.WndQuest;
import com.retrodevxp.pixeldungeon.windows.WndWandmaker;
...
public class Wandmaker extends NPC {
	...
	public String description() {
		return 
			"This old but hale gentleman wears a slightly confused expression in contrast with his majestic robes. " +
			"He seems to be protected by a strong magical shield.";
	}
	...
	private static final QuestHandler dustQuest = new QuestHandler() {
		{
			...
			txtQuest2 = 
				"Any luck with _corpse dust_, %s? Bone piles are the most obvious places to look. Don't worry, I'm not in a hurry. Keep looking.";
		}
	...
	private static final QuestHandler fishQuest = new QuestHandler() {
		{
			txtQuest1 = 
				...
				"it's very embarrassing. Probably you could help me? I would be happy to pay for your service with one of my best wands.";
			txtQuest2 = 
				"Any luck with a _phantom fish_, %s? You may want to try searching for it in one of the local pools. Don't worry, I'm not in a hurry. Keep searching.";
		}

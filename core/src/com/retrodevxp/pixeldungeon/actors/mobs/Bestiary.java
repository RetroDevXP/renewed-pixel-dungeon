...
import com.retrodevxp.pixeldungeon.actors.mobs.Yog.BurningFist;
import com.retrodevxp.pixeldungeon.actors.mobs.Yog.RottingFist;
...
public class Bestiary {
	...
	private static Class<?> mobClass( int depth ) {
		...
		case 6:
			chances = new float[]{ 4, 2, 1,   0.2f , 0.7f };
		...
		case 17:
			...
			break;
		case 18:
			chances = new float[]{ 1, 2, 1, 0.05f, 1 };
			classes = new Class<?>[]{ Elemental.class, Monk.class, Golem.class, DwarfWarrior.class,  Warlock.class };
			break;
		case 19:
			chances = new float[]{ 1, 2, 3, 1, 0.25f,    0.02f };
			classes = new Class<?>[]{ Elemental.class, Monk.class, Golem.class, Warlock.class, DwarfWarrior.class,   Succubus.class };
			break;

...
public class FrostDart extends MissileWeapon {

	public static final float DURATION	= 5f;
	
	{
		name = "frost dart";
		image = ItemSpriteSheet.FROST_DART;
	...
	public String desc() {
		return 
			"The substances in the tips of these darts mixes into a freezing compound when activated. " +
			"It leaves the target slowed by the cold.";
	}

...
import com.retrodevxp.pixeldungeon.actors.mobs.Mimic;
import com.retrodevxp.pixeldungeon.actors.mobs.Wraith;
...
import com.retrodevxp.pixeldungeon.items.food.BulbushFruitFrozen;
	...
	public void burn() {
		...
		for (Item item : items.toArray( new Item[0] )) {
			if (item instanceof Scroll) {
				...
				replace( item, BulbushFruitCooked.cook( (BulbushFruit)item ) );
				burnt = true;
			}
		}
	...
	public void freeze() {
		...
		for (Item item : items.toArray( new Item[0] )) {
			if (item instanceof MysteryMeat) {
				...
				replace( item, BulbushFruitFrozen.cook( (BulbushFruit)item ) );
				frozen = true;
			}
		}

...
public class ItemSpriteSheet {
	...
	public static final int SHELLDART		= 129;
	public static final int WOODENDART		= 133;
	public static final int FROST_DART		= 139;
	public static final int SERRATED_SPIKE		= 153;
	...
	public static final int ARMOR_BRASS		= 130;
	public static final int ARMOR_HARDCLOTH	= 132;
	...
	public static final int WAND_PINE			= 160;
	public static final int WAND_ALDER			= 161;
	...
	public static final int SEED_BULBUSH	= 144;
	public static final int SEED_HARDTHORN	= 145;
	...
	public static final int BULBUSHFRUIT		= 141;
	public static final int BULBUSHCOOKED		= 142;
	public static final int BULBUSHFROZEN		= 143;
	...
	public static final int SMOKEBOMB	= 135;
	public static final int FIREBOMB	= 138;
	public static final int DIZZYBOMB	= 140;

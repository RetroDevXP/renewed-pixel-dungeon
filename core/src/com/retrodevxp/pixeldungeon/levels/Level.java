...
import com.retrodevxp.noosa.Scene;
...
import com.retrodevxp.pixeldungeon.actors.buffs.Awareness;
...
import com.retrodevxp.pixeldungeon.effects.particles.FlowParticle;
import com.retrodevxp.pixeldungeon.effects.particles.WindParticle;
...
import com.retrodevxp.pixeldungeon.levels.Level.Feeling;
import com.retrodevxp.pixeldungeon.levels.features.Chasm;
import com.retrodevxp.pixeldungeon.levels.features.Door;
import com.retrodevxp.pixeldungeon.levels.features.HighGrass;
import com.retrodevxp.pixeldungeon.levels.painters.Painter;
import com.retrodevxp.pixeldungeon.levels.traps.*;
import com.retrodevxp.pixeldungeon.mechanics.ShadowCaster;
...
public abstract class Level implements Bundlable {
	...
	public boolean[] updateFieldOfView( Char c ) {
		...
		if (c.isAlive()) {
			...
			else if (c == Dungeon.hero && ((Hero)c).subClass == HeroSubClass.SPY) {
				for (Mob mob : mobs) {
					int p = mob.pos;
					if (distance( c.pos, p) == 2) {
						fieldOfView[p] = true;

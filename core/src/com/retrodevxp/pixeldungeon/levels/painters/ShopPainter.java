...
import com.retrodevxp.pixeldungeon.actors.mobs.npcs.ImpShopkeeper;
...
import com.retrodevxp.pixeldungeon.items.Torch;
import com.retrodevxp.pixeldungeon.items.Weightstone;
...
import com.retrodevxp.pixeldungeon.items.food.OverpricedRation;
...
public class ShopPainter extends Painter {
	...
	private static void placeShopkeeper( Level level, Room room ) {
		...
		try{
			if (Level.water[pos]){
				shopkeeper.name = "amphibious imp";
			}
		}
		catch(Exception ex){

...
public class Sign {
	...
	private static final String[] TIPS = {
		...
		"Being hungry doesn't hurt, but starving does hurt. You also deal less damage when starving.",
		...
		"There is no sense in possessing more than one Ankh at the same time, because you will lose all unequipped items, including other Ankhs, upon resurrecting.",
		...
		"Enchantments aren't always a positive thing in all situations. Several enchantments come at potentially dire costs.",
		"The only way to obtain a Scroll of Wipe Out is to receive it from a sacrificial altar as a gift from the dungeon spirits.",
